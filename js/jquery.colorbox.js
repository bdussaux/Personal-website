	...
	function addBindings() {
		...
		if ($box) {
			if (!init) {
				...
				$next.click(function () {
					 $("#cboxPrevious").css({"opacity": 0,"visibility": "hidden"});
                    $("#cboxNext").css({"opacity": 0,"visibility": "hidden"});
                    $("#cboxClose").css({"opacity": 0,"visibility": "hidden"});
                    $("#cboxPrevious").removeClass();
                    $("#cboxNext").removeClass();
